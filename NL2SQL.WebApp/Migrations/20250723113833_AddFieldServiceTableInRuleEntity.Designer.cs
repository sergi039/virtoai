...
namespace NL2SQL.WebApp.Migrations
{
    ...
    [Migration("20250723113833_AddFieldServiceTableInRuleEntity")]
    partial class AddFieldServiceTableInRuleEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NL2SQL.WebApp.Entities.HiddenTableFieldEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("NL2SQL.WebApp.Entities.ServiceRedirectRuleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("ServiceTableEntityId")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ServiceTableEntityId");

                    b.ToTable("service_redirect_rules");
                });
            ...
            modelBuilder.Entity("NL2SQL.WebApp.Entities.ServiceRedirectRuleEntity", b =>
                {
                    b.HasOne("NL2SQL.WebApp.Entities.ServiceTableEntity", "ServiceTableEntity")
                        .WithMany("RedirectRules")
                        .HasForeignKey("ServiceTableEntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ServiceTableEntity");
                });
