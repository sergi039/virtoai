...
namespace NL2SQL.WebApp.Migrations
{
    ...
    [Migration("20250721095839_AddNewFieldInServiceTable")]
    partial class AddNewFieldInServiceTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NL2SQL.WebApp.Entities.ServiceTableEntity", b =>
                {
                    ...
                    b.Property<string>("RedirectFieldName")
                        .HasColumnType("text")
                        .HasColumnName("redirect_field_name");

                    b.Property<string>("RedirectUrlTemplate")
                        .HasColumnType("text")
                        .HasColumnName("redirect_url_template");
